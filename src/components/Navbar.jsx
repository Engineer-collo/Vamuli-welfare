    ...
    <nav className="bg-green-700 text-white shadow-md">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center p-4">
        ...
        <ul className="hidden md:flex gap-6 text-sm mt-3 md:mt-0">
          ...
          <li>
            <Link to="/loan" className="hover:text-gray-200">Loan Form</Link>
          </li>
          <li>
      ...
      {menuOpen && (
        <div className="md:hidden bg-green-600">
          <ul className="flex flex-col items-center gap-4 py-4 text-sm">
            ...
            <li><Link to="/members" onClick={() => setMenuOpen(false)}>Members</Link></li>
            <li><Link to="/constitution" onClick={() => setMenuOpen(false)}>Welfare-Constitution</Link></li>
            <li><Link to="/contributions" onClick={() => setMenuOpen(false)}>Contributions</Link></li>
            <li><Link to="/signatories" onClick={() => setMenuOpen(false)}>Signatories</Link></li>
            <li><Link to="/loan" onClick={() => setMenuOpen(false)}>Loan Form</Link></li>
            <li><Link to="/certificates" onClick={() => setMenuOpen(false)}>Membership Certificate</Link></li>
          </ul>
        </div>
      )}
    </nav>
