      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700">
          ...
          kiwango cha kutoa ni Ksh.500 kila mwezi. the previous months contribution should not exceed 5th of the following month. or else a late penalty fee 
           of Ksh.100 shall be applied and if a member misses 3 consucutive contributions he/she shall be expelled from the welfare unless he pays all the pending contributions plus fines of Ksh 3
        </p>
      </section>
