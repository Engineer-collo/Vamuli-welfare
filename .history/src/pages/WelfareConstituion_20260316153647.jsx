      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700">
          ...
          kiwango cha kutoa ni Ksh.500 kila mwezi. the previous months contribution should not exceed 5th of the following month. or else a late penalty fee 
           ...
           if a member was expelled and wishes to come back to the welfare he/she shall be required to pay all the accrude fines and missed contributions before being declared again as a member by the chairman or the deputy-chairman
        </p>
      </section>
