  ...
  return (
    <div className="max-w-5xl mx-auto mt-10 bg-white shadow-lg rounded-lg p-8">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700">
          Each member shall contribute the agreed monthly contribution amount.
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700">
          The welfare shall be guided by elected leaders including Chairman, Deputy-Chairman, Fines-off Treasurer
          Coordinator and a Secretary. These leaders will ensure proper
      ...
      <section>
        ...
        <p className="text-gray-700">
          Members shall hold meetings whenever necessary to discuss welfare
