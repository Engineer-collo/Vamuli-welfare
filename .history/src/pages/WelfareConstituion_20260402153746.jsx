...
function Constitution() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content:
        "If a member is removed from the welfare, or they leave at will they will not be refundend their contribution. Because some of the developments and invet",
    },
  ];
