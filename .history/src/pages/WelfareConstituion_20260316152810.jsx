    ...
    <div className="max-w-5xl mx-auto mt-10 bg-white shadow-lg rounded-lg p-8">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700">
          ...
          kiwango cha kutoa ni 500 kila mwezi. the previous months contribution should not exceed 5th of the following month. or else a late penalty fee <object data="" type=""></object>
        </p>
      </section>
